...
const BASE_FOODS = [
  ...
  { id: "domates_corbasi", name: "Domates Çorbası", category: "corba", calories: 80, portion: "1 kase" },
  { id: "kozlenmis_domates_corbasi", name: "Közlenmiş Domates Çorbası", category: "corba", calories: 90, portion: "1 kase" },
  { id: "brokoli_corbasi", name: "Brokoli Çorbası", category: "corba", calories: 80, portion: "1 kase" },
  { id: "kremali_sebze_corbasi", name: "Kremalı Sebze Çorbası", category: "corba", calories: 180, portion: "1 kase" },
  { id: "misirli_kremali_sebze_corbasi", name: "Mısırlı ve Kremalı Sebze Çorbası", category: "corba", calories: 180, portion: "1 kase" },
  ...
  { id: "zencefilli_havuclu_kremali_corba", name: "Zencefilli ve Havuçlu Kremalı Çorba", category: "corba", calories: 150, portion: "1 kase" },
  ...
  { id: "tatli_eksi_soslu_tavuk", name: "Tatlı-Ekşi Soslu Tavuk", category: "ana_et", calories: 380, portion: "1 porsiyon" },
  ...
  { id: "tavuklu_bezelye", name: "Tavuklu Bezelye", category: "ana_et", calories: 320, portion: "1 porsiyon" },
  ...
  { id: "tavuk_but", name: "Soslu Tavuk But", category: "ana_et", calories: 450, portion: "1 porsiyon" },
  ...
  { id: "tavuk_fajita", name: "Tavuk Fajita", category: "ana_et", calories: 350, portion: "1 porsiyon" },
  ...
  { id: "ekmek_arasi_kofte", name: "Ekmek Arası Köfte", category: "ana_et", calories: 600, portion: "1 porsiyon" },
  { id: "inegol_kofte", name: "İnegöl Köfte", category: "ana_et", calories: 450, portion: "1 porsiyon" },
  { id: "izmir_kofte", name: "İzmir Köfte", category: "ana_et", calories: 450, portion: "1 porsiyon" },
  { id: "kadinbudu_kofte", name: "Kadınbudu Köfte", category: "ana_et", calories: 500, portion: "1 porsiyon" },
  ...
  { id: "sebzeli_kebap", name: "Sebzeli Kebap", category: "ana_et", calories: 350, portion: "1 porsiyon" },
  ...
  { id: "coban_kavurma", name: "Çoban Kavurma", category: "ana_et", calories: 650, portion: "1 porsiyon" },
  { id: "alman_usulu_patates", name: "Alman Usulü Patates Salatası", category: "salata", calories: 300, portion: "1 porsiyon" },
  { id: "kiymali_kapuska", name: "Kıymalı Kapuska", category: "ana_et", calories: 300, portion: "1 porsiyon" },
  ...
  { id: "yesil_mercimek_yemegi", name: "Yeşil Mercimek Yemeği", category: "ana_sebze", calories: 300, portion: "1 porsiyon" },
  { id: "zeytinyagli_pirasa", name: "Zeytinyağlı Pırasa", category: "ana_sebze", calories: 200, portion: "1 porsiyon" },
  { id: "firinlanmis_ispanak_graten", name: "Fırınlanmış Ispanak Graten", category: "ana_sebze", calories: 300, portion: "1 porsiyon" },
  { id: "ispanak_graten", name: "Ispanak Graten", category: "ana_sebze", calories: 320, portion: "1 porsiyon" },
  ...
  { id: "nohut_yemegi", name: "Nohut Yemeği", category: "ana_sebze", calories: 350, portion: "1 porsiyon" },
  ...
  { id: "elma_dilim_patates", name: "Elma Dilim Patates", category: "ana_sebze", calories: 350, portion: "1 porsiyon" },
  { id: "baharatli_elma_dilim_patates", name: "Baharatlı Elma Dilim Patates", category: "ana_sebze", calories: 380, portion: "1 porsiyon" },
  { id: "piyaz", name: "Piyaz", category: "ana_sebze", calories: 280, portion: "1 porsiyon" },
  { id: "patates_piyazi", name: "Patates Piyazı", category: "ana_sebze", calories: 250, portion: "1 porsiyon" },
  ...
  // ═══ PİLAVLAR ═══
  { id: "pirinc_pilavi", name: "Pirinç Pilavı", category: "pilav", calories: 300, portion: "1 porsiyon" },
  { id: "sade_pirinc_pilavi", name: "Sade Pirinç Pilavı", category: "pilav", calories: 300, portion: "1 porsiyon" },
  { id: "sebzeli_pirinc_pilavi", name: "Sebzeli Pirinç Pilavı", category: "pilav", calories: 280, portion: "1 porsiyon" },
  { id: "bulgur_pilavi", name: "Bulgur Pilavı", category: "pilav", calories: 280, portion: "1 porsiyon" },
  { id: "siyez_bulgur_pilavi", name: "Siyez Bulgur Pilavı", category: "pilav", calories: 280, portion: "1 porsiyon" },
  ...
  { id: "zerdecalli_misirli_pirinc_pilavi", name: "Zerdeçallı Mısırlı Pirinç Pilavı", category: "pilav", calories: 350, portion: "1 porsiyon" },
  { id: "domatesli_sehriye_pilavi", name: "Domatesli Şehriye Pilavı", category: "pilav", calories: 300, portion: "1 porsiyon" },
  { id: "sehriyeli_bulgur_pilavi", name: "Şehriyeli Bulgur Pilavı", category: "pilav", calories: 300, portion: "1 porsiyon" },
  { id: "sebzeli_meyhane_pilavi", name: "Sebzeli Meyhane Pilavı", category: "pilav", calories: 300, portion: "1 porsiyon" },
  ...
  { id: "sehriyeli_pirinc_pilavi", name: "Şehriyeli Pirinç Pilavı", category: "pilav", calories: 320, portion: "1 porsiyon" },
  { id: "sebzeli_kuskus_pilavi", name: "Sebzeli Kuskus Pilavı", category: "pilav", calories: 300, portion: "1 porsiyon" },
  ...
  { id: "sebzeli_siyez_bulgur_pilavi", name: "Sebzeli Siyez Bulgur Pilavı", category: "pilav", calories: 270, portion: "1 porsiyon" },

  // ═══ MAKARNALAR ═══
  { id: "domates_soslu_penne", name: "Domates Soslu Penne Makarna", category: "makarna", calories: 320, portion: "1 porsiyon" },
  ...
  { id: "peynirli_eriste", name: "Peynirli Erişte", category: "makarna", calories: 380, portion: "1 porsiyon" },
  ...
  { id: "mevsim_salatasi_yagli", name: "Mevsim Salatası (Yağlı)", category: "salata", calories: 120, portion: "1 porsiyon" },
  { id: "mevsim_salatasi_yogurt", name: "Mevsim Salatası (Yoğurtlu)", category: "salata", calories: 80, portion: "1 porsiyon" },
  { id: "akdeniz_salatasi", name: "Akdeniz Salatası", category: "salata", calories: 180, portion: "1 porsiyon" },
  { id: "gavurdagi_salatasi", name: "Gavurdağı Salatası", category: "salata", calories: 200, portion: "1 porsiyon" },
  { id: "meksika_fasulye_salata", name: "Meksika Fasulyeli Salata", category: "salata", calories: 220, portion: "1 porsiyon" },
  { id: "sumakli_sogan_salatasi", name: "Sumaklı Soğan Salatası", category: "salata", calories: 80, portion: "1 porsiyon" },
  { id: "coleslaw_salatasi", name: "Coleslaw Salatası", category: "salata", calories: 200, portion: "1 porsiyon" },
  ...
  { id: "sogus_salatasi", name: "Söğüş Salatası", category: "salata", calories: 60, portion: "1 porsiyon" },
  { id: "yesil_salata", name: "Yeşil Salata", category: "salata", calories: 30, portion: "1 porsiyon" },
  { id: "kis_patates_salatasi", name: "Köz Patates Salatası", category: "salata", calories: 250, portion: "1 porsiyon" },
  { id: "salatalik_tursusu", name: "Salatalık Turşusu", category: "salata", calories: 20, portion: "1 porsiyon" },
  { id: "pancar_tursusu", name: "Pancar Turşusu", category: "salata", calories: 50, portion: "1 porsiyon" },
  { id: "karisik_tursu", name: "Karışık Turşu", category: "salata", calories: 30, portion: "1 porsiyon" },
  ...
  { id: "kazandibi", name: "Kazandibi", category: "tatli", calories: 150, portion: "1 porsiyon" },
  ...
  { id: "kek", name: "Kek", category: "tatli", calories: 350, portion: "1 porsiyon" },
  ...
  { id: "muz", name: "Muz", category: "meyve", calories: 100, portion: "1 adet" },
